...
#define HCI_LE_2M_PHY_SUPPORTED(x) \
  ((x)[HCI_LE_FEATURE_2M_PHY_OFF] & HCI_LE_FEATURE_2M_PHY_MASK)

/* LE Coded PHY : bit 11 */
#define HCI_LE_FEATURE_CODED_PHY_MASK 0x08
#define HCI_LE_FEATURE_CODED_PHY_OFF 1
#define HCI_LE_CODED_PHY_SUPPORTED(x) \
  ((x)[HCI_LE_FEATURE_CODED_PHY_OFF] & HCI_LE_FEATURE_CODED_PHY_MASK)
...
#define HCI_SUPP_COMMANDS_LE_READ_PHY_MASK 0x10
#define HCI_SUPP_COMMANDS_LE_READ_PHY_OFF 35
#define HCI_LE_READ_PHY_SUPPORTED(x) \
  ((x)[HCI_SUPP_COMMANDS_LE_READ_PHY_OFF] & HCI_SUPP_COMMANDS_LE_READ_PHY_MASK)

#define HCI_SUPP_COMMANDS_LE_SET_DEFAULT_PHY_MASK 0x20
#define HCI_SUPP_COMMANDS_LE_SET_DEFAULT_PHY_OFF 35
#define HCI_LE_SET_DEFAULT_PHY_SUPPORTED(x)        \
  ((x)[HCI_SUPP_COMMANDS_LE_SET_DEFAULT_PHY_OFF] & \
   HCI_SUPP_COMMANDS_LE_SET_DEFAULT_PHY_MASK)

#define HCI_SUPP_COMMANDS_LE_SET_PHY_MASK 0x40
#define HCI_SUPP_COMMANDS_LE_SET_PHY_OFF 35
#define HCI_LE_SET_PHY_SUPPORTED(x) \
  ((x)[HCI_SUPP_COMMANDS_LE_SET_PHY_OFF] & HCI_SUPP_COMMANDS_LE_SET_PHY_MASK)

#define HCI_SUPP_COMMANDS_LE_ENH_RX_TEST_MASK 0x80
#define HCI_SUPP_COMMANDS_LE_ENH_RX_TEST_OFF 35
#define HCI_LE_ENH_RX_TEST_SUPPORTED(x)        \
  ((x)[HCI_SUPP_COMMANDS_LE_ENH_RX_TEST_OFF] & \
   HCI_SUPP_COMMANDS_LE_ENH_RX_TEST_MASK)

/* Supported Commands Byte 36, only bits 0 - 0 are defined */
#define HCI_SUPP_COMMANDS_LE_ENH_TX_TEST_MASK 0x01
#define HCI_SUPP_COMMANDS_LE_ENH_TX_TEST_OFF 36
#define HCI_LE_ENH_TX_TEST_SUPPORTED(x)        \
