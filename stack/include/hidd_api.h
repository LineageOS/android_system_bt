...
**
*******************************************************************************/
extern tHID_STATUS HID_DevAddRecord(UINT32 handle, char *p_name, char *p_description,
...
**
*******************************************************************************/
extern tHID_STATUS HID_DevSendReport(UINT8 channel, UINT8 type, UINT8 id, UINT16 len,
                                            UINT8 *p_data);
